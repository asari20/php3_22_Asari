...
if($status == false){
 ...
 while( $result = $stmt->fetch(PDO::FETCH_ASSOC)){ 
   ...
   $view .= '<object><label class="text-center text-white bg-indigo-500 border-0 py-2 px-8 mb-2 hover:bg-indigo-600 hover:cursor-pointer rounded"><a href='.$result['url'].'>リンク</a></label></object>';
